...
class VulkanCommandImplicitExternsyncParam(registry: Registry,vulkanCommand: VulkanCommand, node: Node) extends VulkanCommandParam(registry,vulkanCommand,node) {

}

object VulkanCommandImplicitExternsyncParam {
  def apply(registry: Registry,vulkanCommand: VulkanCommand,node: Node): VulkanComponentMappedData[VulkanCommandImplicitExternsyncParam] =
