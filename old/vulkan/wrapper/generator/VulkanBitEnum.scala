...
/**
  ...
  */
class VulkanBitEnum(element:Element,registy:VulkanRegistry) extends VulkanType with VulkanGenerator {
  lazy val name = element.getElementsByTagName("name").item(0).getTextContent.replaceAll("Flags","FlagBits")
  ...
  val bitmask = new VulkanBitmask(this,registy)
